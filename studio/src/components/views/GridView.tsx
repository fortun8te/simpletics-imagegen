...
// out as: BatchHero → ad section → variation row → a responsive grid of slot cards (one per slot of
// every prompt). Honors `density` (card min width) and `showArchived` (hide archived slots).
